...
program test_program;
  ...
  initial begin
    ...
    regmap = new(
      "DMAC regmap",
      `TH.dut_rx_dma.inst.AXI_AXCACHE,
      `TH.dut_rx_dma.inst.AXI_AXPROT,
      `TH.dut_rx_dma.inst.BYTES_PER_BURST_WIDTH,
      `TH.dut_rx_dma.inst.CACHE_COHERENT,
      `TH.dut_rx_dma.inst.CYCLIC,
      `TH.dut_rx_dma.inst.DMA_DATA_WIDTH_DEST,
      `TH.dut_rx_dma.inst.DMA_DATA_WIDTH_SRC,
      `TH.dut_rx_dma.inst.DMA_TYPE_DEST,
      `TH.dut_rx_dma.inst.DMA_TYPE_SRC,
      `TH.dut_rx_dma.inst.ID);
