...
source $ad_hdl_dir/projects/fmcomms8/common/fmcomms8_bd.tcl
...
set_property -dict [list CONFIG.NUM_MI {16}] [get_bd_cells axi_axi_interconnect]
ad_connect i_rx_jesd_exerciser/S00_AXI_0 axi_axi_interconnect/M15_AXI
ad_connect sys_cpu_clk axi_axi_interconnect/M15_ACLK
ad_connect sys_cpu_resetn axi_axi_interconnect/M15_ARESETN
...
set_property -dict [list CONFIG.NUM_MI {17}] [get_bd_cells axi_axi_interconnect]
ad_connect i_tx_jesd_exerciser/S00_AXI_0 axi_axi_interconnect/M16_AXI
ad_connect sys_cpu_clk axi_axi_interconnect/M16_ACLK
ad_connect sys_cpu_resetn axi_axi_interconnect/M16_ARESETN
...
ad_connect i_tx_os_jesd_exerciser/S00_AXI_0 axi_axi_interconnect/M17_AXI
...
set DUT_AXI_XCVR_TX 0x45A20000
set_property offset $DUT_AXI_XCVR_TX [get_bd_addr_segs {mng_axi_vip/Master_AXI/SEG_data_axi_adrv9009_fmc_tx_xcvr}]
adi_sim_add_define "DUT_AXI_XCVR_TX_BA=[format "%d" ${DUT_AXI_XCVR_TX}]"

set AXI_JESD_TX 0x45A30000
set_property offset $AXI_JESD_TX [get_bd_addr_segs {mng_axi_vip/Master_AXI/SEG_data_axi_adrv9009_fmc_tx_jesd}]
adi_sim_add_define "AXI_JESD_TX_BA=[format "%d" ${AXI_JESD_TX}]"

set DAC_TPL 0x45A04000
set_property offset $DAC_TPL [get_bd_addr_segs {mng_axi_vip/Master_AXI/SEG_data_tx_adrv9009_fmc_tpl_core}]
adi_sim_add_define "DAC_TPL_BA=[format "%d" ${DAC_TPL}]"

set TX_DMA 0x7D400000
set_property offset $TX_DMA [get_bd_addr_segs {mng_axi_vip/Master_AXI/SEG_data_axi_adrv9009_fmc_tx_dma}]
adi_sim_add_define "TX_DMA_BA=[format "%d" ${TX_DMA}]"

set TX_OFFLOAD 0x7D410000
set_property offset $TX_OFFLOAD [get_bd_addr_segs {mng_axi_vip/Master_AXI/SEG_data_adrv9009_fmc_data_offload}]
adi_sim_add_define "TX_OFFLOAD_BA=[format "%d" ${TX_OFFLOAD}]"

set EX_AXI_XCVR_RX 0x55A20000
...
set DUT_AXI_XCVR_RX 0x45A40000
set_property offset $DUT_AXI_XCVR_RX [get_bd_addr_segs {mng_axi_vip/Master_AXI/SEG_data_axi_adrv9009_fmc_rx_xcvr}]
adi_sim_add_define "DUT_AXI_XCVR_RX_BA=[format "%d" ${DUT_AXI_XCVR_RX}]"

set AXI_JESD_RX 0x45A50000
set_property offset $AXI_JESD_RX [get_bd_addr_segs {mng_axi_vip/Master_AXI/SEG_data_axi_adrv9009_fmc_rx_jesd}]
adi_sim_add_define "AXI_JESD_RX_BA=[format "%d" ${AXI_JESD_RX}]"

set ADC_TPL 0x45A00000
set_property offset $ADC_TPL [get_bd_addr_segs {mng_axi_vip/Master_AXI/SEG_data_rx_adrv9009_fmc_tpl_core}]
adi_sim_add_define "ADC_TPL_BA=[format "%d" ${ADC_TPL}]"

set RX_DMA 0x7D420000
set_property offset $RX_DMA [get_bd_addr_segs {mng_axi_vip/Master_AXI/SEG_data_axi_adrv9009_fmc_rx_dma}]
adi_sim_add_define "RX_DMA_BA=[format "%d" ${RX_DMA}]"

set EX_AXI_XCVR_TX 0x55A40000
...
set DUT_AXI_XCVR_RX_OS 0x45A60000
set_property offset $DUT_AXI_XCVR_RX_OS [get_bd_addr_segs {mng_axi_vip/Master_AXI/SEG_data_axi_adrv9009_fmc_obs_xcvr}]
adi_sim_add_define "DUT_AXI_XCVR_RX_OS_BA=[format "%d" ${DUT_AXI_XCVR_RX_OS}]"

set AXI_JESD_RX_OS 0x45A70000
set_property offset $AXI_JESD_RX_OS [get_bd_addr_segs {mng_axi_vip/Master_AXI/SEG_data_axi_adrv9009_fmc_obs_jesd}]
adi_sim_add_define "AXI_JESD_RX_OS_BA=[format "%d" ${AXI_JESD_RX_OS}]"

set ADC_OS_TPL 0x45A08000
set_property offset $ADC_OS_TPL [get_bd_addr_segs {mng_axi_vip/Master_AXI/SEG_data_obs_adrv9009_fmc_tpl_core}]
adi_sim_add_define "ADC_OS_TPL_BA=[format "%d" ${ADC_OS_TPL}]"

set RX_OS_DMA 0x7D440000
set_property offset $RX_OS_DMA [get_bd_addr_segs {mng_axi_vip/Master_AXI/SEG_data_axi_adrv9009_fmc_obs_dma}]
adi_sim_add_define "RX_OS_DMA_BA=[format "%d" ${RX_OS_DMA}]"

set EX_AXI_XCVR_TX_OS 0x55A60000
...
set EX_AXI_JESD_TX_OS 0x55A70000
