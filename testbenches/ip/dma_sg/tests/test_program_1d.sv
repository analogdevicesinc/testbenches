...
program test_program_1d;
  ...
  initial begin
    ...
    // 2nd Descriptor
    write_descriptor(.desc_addr     (xil_axi_uint'(`DDR_BA+'h1_0030)), .flags(2'b00), .id   ('h4567), .src_addr  (xil_axi_uint'(`DDR_BA+'h1000)), .dest_addr (0),
    ...
    // 4th Descriptor
    write_descriptor(.desc_addr     (xil_axi_uint'(`DDR_BA+'h1_0090)), .flags(2'b00), .id   ('hCDEF), .src_addr  (xil_axi_uint'(`DDR_BA+'h3000)), .dest_addr (0),
    ...
    // 6th Descriptor
    write_descriptor(.desc_addr     (xil_axi_uint'(`DDR_BA+'h1_00F0)), .flags(2'b00), .id   ('hCCDD), .src_addr  (xil_axi_uint'(`DDR_BA+'h5000)), .dest_addr (0),
    ...
    write_descriptor(.desc_addr     (xil_axi_uint'(`DDR_BA+'h1_1030)), .flags(2'b00), .id   ('h7654), .src_addr  (0), .dest_addr(xil_axi_uint'(`DDR_BA+'h9000)),
                     .next_desc_addr(xil_axi_uint'(`DDR_BA+'h1_1090)), .y_len(0),     .x_len('h0FFF), .src_stride(0), .dst_stride(0));
    // 3rd Descriptor
    write_descriptor(.desc_addr     (xil_axi_uint'(`DDR_BA+'h1_1060)), .flags(2'b00), .id   ('hBA98), .src_addr  (0), .dest_addr(xil_axi_uint'(`DDR_BA+'hA000)),
                     .next_desc_addr(xil_axi_uint'(`DDR_BA+'h1_1030)), .y_len(0),     .x_len('h0FFF), .src_stride(0), .dst_stride(0));
    // 4th Descriptor
    write_descriptor(.desc_addr     (xil_axi_uint'(`DDR_BA+'h1_1090)), .flags(2'b11), .id   ('hFEDC), .src_addr  (0), .dest_addr(xil_axi_uint'(`DDR_BA+'hB000)),
                     .next_desc_addr(xil_axi_uint'(`DDR_BA+'h1_FFFF)), .y_len(0),     .x_len('h0FFF), .src_stride(0), .dst_stride(0));
    // 5th Descriptor
    write_descriptor(.desc_addr     (xil_axi_uint'(`DDR_BA+'h1_10C0)), .flags(2'b00), .id   ('hDCDC), .src_addr  (0), .dest_addr(xil_axi_uint'(`DDR_BA+'hC000)),
                     .next_desc_addr(xil_axi_uint'(`DDR_BA+'h1_10F0)), .y_len(0),     .x_len('h1FFF), .src_stride(0), .dst_stride(0));
    // 6th Descriptor
    write_descriptor(.desc_addr     (xil_axi_uint'(`DDR_BA+'h1_10F0)), .flags(2'b11), .id   ('hFEFE), .src_addr  (0), .dest_addr(xil_axi_uint'(`DDR_BA+'hE000)),
                     .next_desc_addr(xil_axi_uint'(`DDR_BA+'h1_FFFF)), .y_len(0),     .x_len('h1FFF), .src_stride(0), .dst_stride(0));
