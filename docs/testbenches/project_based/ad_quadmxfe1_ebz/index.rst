...
of the :git-hdl:`projects/ad_quadmxfe1_ebz` reference design.

The entire HDL documentation can be found here
:external+hdl:ref:`AD-QUADMXFE1-EBZ HDL project <ad_quadmxfe1_ebz>`.

Block design
-------------------------------------------------------------------------------

The testbench block design includes part of the AD-QUADMXFE1-EBZ HDL reference
...
.. image:: ./ad_quadmxfe1_ebz_tb.svg
   :width: 800
   :align: center
   :alt: ad_quadmxfe1_ebz/Testbench block diagram
...
- TX_KS_PER_CHANNEL
- RD_DATA_REGISTERED
- RD_FIFO_ADDRESS_WIDTH
- JESD_MODE: the JESD204B link mode (1: JESD_8B10B encoding; 2: JESD_64B66B
- [RX/TX]_LANE_RATE: the JESD204B lane rate in Gbps
...
- [RX/TX]_JESD_K: number of framer per multiframe
- [RX/TX]_NUM_LINKS
- DAC_TPL_XBAR_ENABLE
