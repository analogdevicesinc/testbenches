...
program test_program;
  ...
  initial begin
    ...
    ex_tx_0_ll = new("EX TX_0_LINK_LAYER", env.mng, `EX_AXI_JESD_TX_0_BA, rx_0_link);
    ex_tx_0_ll.probe();

    ex_tx_1_ll = new("EX TX_1_LINK_LAYER", env.mng, `EX_AXI_JESD_TX_1_BA, rx_1_link);
    ex_tx_1_ll.probe();

    ex_tx_0_xcvr = new("EX TX_0_XCVR", env.mng, `EX_AXI_XCVR_TX_0_BA);
    ex_tx_0_xcvr.probe();

    ex_tx_1_xcvr = new("EX TX_1_XCVR", env.mng, `EX_AXI_XCVR_TX_1_BA);
    ex_tx_1_xcvr.probe();

    dut_rx_0_xcvr = new("DUT RX_0_XCVR", env.mng, `DUT_AXI_XCVR_RX_0_BA);
    dut_rx_0_xcvr.probe();

    dut_rx_1_xcvr = new("DUT RX_1_XCVR", env.mng, `DUT_AXI_XCVR_RX_1_BA);
    dut_rx_1_xcvr.probe();

    dut_rx_0_ll = new("DUT RX_0_LINK_LAYER", env.mng, `AXI_JESD_RX_0_BA, rx_0_link);
    dut_rx_0_ll.probe();

    dut_rx_1_ll = new("DUT RX_1_LINK_LAYER", env.mng, `AXI_JESD_RX_1_BA, rx_1_link);
    dut_rx_1_ll.probe();
  ...
  task rx_tpl_test(int use_dds);
    for (int i = 0; i < `RX_JESD_M; i++) begin
      if (use_dds) begin
        ...
        env.mng.RegWrite32(`EX_DAC_0_TPL_BA+'h40*i+GetAddrs(DAC_CHANNEL_REG_CHAN_CNTRL_7),
                           `SET_DAC_CHANNEL_REG_CHAN_CNTRL_7_DAC_DDS_SEL(0));
        env.mng.RegWrite32(`EX_DAC_1_TPL_BA+'h40*i+GetAddrs(DAC_CHANNEL_REG_CHAN_CNTRL_7),
                           `SET_DAC_CHANNEL_REG_CHAN_CNTRL_7_DAC_DDS_SEL(0));
        // Configure tone amplitude and frequency
        env.mng.RegWrite32(`EX_DAC_0_TPL_BA+'h40*i+GetAddrs(DAC_CHANNEL_REG_CHAN_CNTRL_1),
                           `SET_DAC_CHANNEL_REG_CHAN_CNTRL_1_DDS_SCALE_1(16'h0fff));
        env.mng.RegWrite32(`EX_DAC_0_TPL_BA+'h40*i+GetAddrs(DAC_CHANNEL_REG_CHAN_CNTRL_2),
                           `SET_DAC_CHANNEL_REG_CHAN_CNTRL_2_DDS_INCR_1(16'h0100));
        env.mng.RegWrite32(`EX_DAC_1_TPL_BA+'h40*i+GetAddrs(DAC_CHANNEL_REG_CHAN_CNTRL_1),
                           `SET_DAC_CHANNEL_REG_CHAN_CNTRL_1_DDS_SCALE_1(16'h0fff));
        env.mng.RegWrite32(`EX_DAC_1_TPL_BA+'h40*i+GetAddrs(DAC_CHANNEL_REG_CHAN_CNTRL_2),
                           `SET_DAC_CHANNEL_REG_CHAN_CNTRL_2_DDS_INCR_1(16'h0100));
    ...
    for (int i = 0; i < `RX_JESD_M; i++) begin
      env.mng.RegWrite32(`ADC_0_TPL_BA+'h40*i+GetAddrs(ADC_CHANNEL_REG_CHAN_CNTRL),
                         `SET_ADC_CHANNEL_REG_CHAN_CNTRL_ENABLE(1));
      env.mng.RegWrite32(`ADC_1_TPL_BA+'h40*i+GetAddrs(ADC_CHANNEL_REG_CHAN_CNTRL),
                         `SET_ADC_CHANNEL_REG_CHAN_CNTRL_ENABLE(1));
    end

    env.mng.RegWrite32(`EX_DAC_0_TPL_BA+GetAddrs(DAC_COMMON_REG_RSTN),
                       `SET_DAC_COMMON_REG_RSTN_RSTN(1));
    env.mng.RegWrite32(`ADC_0_TPL_BA+GetAddrs(ADC_COMMON_REG_RSTN),
                       `SET_ADC_COMMON_REG_RSTN_RSTN(1));
    env.mng.RegWrite32(`EX_DAC_1_TPL_BA+GetAddrs(DAC_COMMON_REG_RSTN),
                       `SET_DAC_COMMON_REG_RSTN_RSTN(1));
    env.mng.RegWrite32(`ADC_1_TPL_BA+GetAddrs(ADC_COMMON_REG_RSTN),
                       `SET_ADC_COMMON_REG_RSTN_RSTN(1));
