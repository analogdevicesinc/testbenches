...
package environment_pkg;
  ...
  class scoreboard_environment #(int `AXIS_VIP_PARAM_ORDER(adc_src), int `AXIS_VIP_PARAM_ORDER(dac_dst), int `AXI_VIP_PARAM_ORDER(adc_dst_pt), int `AXI_VIP_PARAM_ORDER(dac_src_pt)) extends adi_environment;
    ...
    axi4stream_mst_agent #(`AXIS_VIP_IF_PARAMS(adc_src)) adc_src_axis_agent_0;
    axi4stream_slv_agent #(`AXIS_VIP_IF_PARAMS(dac_dst)) dac_dst_axis_agent_0;
    axi_passthrough_mem_agent #(`AXI_VIP_PARAM_ORDER(adc_dst_pt)) adc_dst_axi_pt_agent_0;
    axi_passthrough_mem_agent #(`AXI_VIP_PARAM_ORDER(dac_src_pt)) dac_src_axi_pt_agent_0;
    ...
    m_axis_sequencer #(`AXIS_VIP_PARAM_ORDER(adc_src)) adc_src_axis_seq_0;
    s_axis_sequencer #(`AXIS_VIP_PARAM_ORDER(dac_dst)) dac_dst_axis_seq_0;
    s_axi_sequencer #(`AXI_VIP_PARAM_ORDER(adc_dst_pt)) adc_dst_axi_pt_seq_0;
    s_axi_sequencer #(`AXI_VIP_PARAM_ORDER(dac_src_pt)) dac_src_axi_pt_seq_0;
    ...
    x_axis_monitor #(`AXIS_VIP_PARAM_ORDER(adc_src)) adc_src_axis_0_mon;
    x_axis_monitor #(`AXIS_VIP_PARAM_ORDER(dac_dst)) dac_dst_axis_0_mon;
    x_axi_monitor #(`AXI_VIP_PARAM_ORDER(adc_dst_pt), WRITE_OP) adc_dst_axi_pt_0_mon;
    x_axi_monitor #(`AXI_VIP_PARAM_ORDER(dac_src_pt), READ_OP) dac_src_axi_pt_0_mon;
    ...
    function new (
      ...
      virtual interface axi4stream_vip_if #(`AXIS_VIP_IF_PARAMS(adc_src)) adc_src_axis_vip_if_0,
      virtual interface axi4stream_vip_if #(`AXIS_VIP_IF_PARAMS(dac_dst)) dac_dst_axis_vip_if_0,
      virtual interface axi_vip_if #(`AXI_VIP_IF_PARAMS(adc_dst_pt)) adc_dst_axi_pt_vip_if_0,
      virtual interface axi_vip_if #(`AXI_VIP_IF_PARAMS(dac_src_pt)) dac_src_axi_pt_vip_if_0
      ...
      adc_src_axis_seq_0 = new("ADC Source AXI Stream Sequencer 0", adc_src_axis_agent_0.driver, this);
      dac_dst_axis_seq_0 = new("DAC Destination AXI Stream Sequencer 0", dac_dst_axis_agent_0.driver, this);
      adc_dst_axi_pt_seq_0 = new("ADC Destination AXI Sequencer 0", adc_dst_axi_pt_agent_0.mem_model, this);
      dac_src_axi_pt_seq_0 = new("DAC Source AXI Sequencer 0", dac_src_axi_pt_agent_0.mem_model, this);
      ...
      adc_src_axis_0_mon = new("ADC Source AXIS 0 Transaction Monitor", adc_src_axis_agent_0.monitor, this);
      dac_dst_axis_0_mon = new("DAC Destination AXIS 0 Transaction Monitor", dac_dst_axis_agent_0.monitor, this);
      adc_dst_axi_pt_0_mon = new("ADC Destination AXI 0 Transaction Monitor", adc_dst_axi_pt_agent_0.monitor, this);
      dac_src_axi_pt_0_mon = new("DAC Source AXI 0 Transaction Monitor", dac_src_axi_pt_agent_0.monitor, this);
