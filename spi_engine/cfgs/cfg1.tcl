...
# Test parameters
set ad_project_params(SPIO_SIZE)            1
set ad_project_params(SYNCHRONOUS_MODE)     0
...
set spi_s_vip_cfg [ list \
    SPIO_SIZE               $ad_project_params(SPIO_SIZE)       \
    SYNCHRONOUS_MODE        $ad_project_params(SYNCHRONOUS_MODE)\
    MODE                    0                                   \
