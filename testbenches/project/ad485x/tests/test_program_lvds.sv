...
program test_program_lvds (
  ...
  task configure_axi();
    ...
    axi_write (`AXI_AD485X_BA + GetAddrs(ADC_COMMON_REG_CNTRL), `SET_ADC_COMMON_REG_CNTRL_NUM_LANES(1));
    ...
    axi_read_v (`AXI_AD485X_BA + GetAddrs(ADC_COMMON_REG_CNTRL), `SET_ADC_COMMON_REG_CNTRL_NUM_LANES(1));
