...
package adi_regmap_i3c_controller_pkg;
  ...
  class adi_regmap_i3c_controller #(int ID);
    ...
    class DEVICE_ID_CLASS #(int ID) extends register_base;
    ...
    DEVICE_ID_CLASS #(ID) DEVICE_ID_R;
    ...
    function new();
      ...
      this.DEVICE_ID_R = new("DEVICE_ID", 'h4);
      ...
      this.CMD_FIFO_ROOM_R = new("CMD_FIFO_ROOM", 'hc0);
      this.CMDR_FIFO_LEVEL_R = new("CMDR_FIFO_LEVEL", 'hc4);
      this.SDO_FIFO_ROOM_R = new("SDO_FIFO_ROOM", 'hc8);
      this.SDI_FIFO_LEVEL_R = new("SDI_FIFO_LEVEL", 'hcc);
      this.IBI_FIFO_LEVEL_R = new("IBI_FIFO_LEVEL", 'hd0);
      this.CMD_FIFO_R = new("CMD_FIFO", 'hd4);
      this.CMDR_FIFO_R = new("CMDR_FIFO", 'hd8);
      this.SDO_FIFO_R = new("SDO_FIFO", 'hdc);
      this.SDI_FIFO_R = new("SDI_FIFO", 'he0);
      this.IBI_FIFO_R = new("IBI_FIFO", 'he4);
      this.FIFO_STATUS_R = new("FIFO_STATUS", 'he8);
      this.OPS_R = new("OPS", 'h100);
      this.IBI_CONFIG_R = new("IBI_CONFIG", 'h140);
      this.DEV_CHAR_R = new("DEV_CHAR", 'h180);
      this.OFFLOAD_CMD_0_R = new("OFFLOAD_CMD_0", 'h2c0);
      this.OFFLOAD_CMD_1_R = new("OFFLOAD_CMD_1", 'h2c4);
      this.OFFLOAD_CMD_2_R = new("OFFLOAD_CMD_2", 'h2c8);
      this.OFFLOAD_CMD_3_R = new("OFFLOAD_CMD_3", 'h2cc);
      this.OFFLOAD_CMD_4_R = new("OFFLOAD_CMD_4", 'h2d0);
      this.OFFLOAD_CMD_5_R = new("OFFLOAD_CMD_5", 'h2d4);
      this.OFFLOAD_CMD_6_R = new("OFFLOAD_CMD_6", 'h2d8);
      this.OFFLOAD_CMD_7_R = new("OFFLOAD_CMD_7", 'h2dc);
      this.OFFLOAD_CMD_8_R = new("OFFLOAD_CMD_8", 'h2e0);
      this.OFFLOAD_CMD_9_R = new("OFFLOAD_CMD_9", 'h2e4);
      this.OFFLOAD_CMD_10_R = new("OFFLOAD_CMD_10", 'h2e8);
      this.OFFLOAD_CMD_11_R = new("OFFLOAD_CMD_11", 'h2ec);
      this.OFFLOAD_CMD_12_R = new("OFFLOAD_CMD_12", 'h2f0);
      this.OFFLOAD_CMD_13_R = new("OFFLOAD_CMD_13", 'h2f4);
      this.OFFLOAD_CMD_14_R = new("OFFLOAD_CMD_14", 'h2f8);
      this.OFFLOAD_CMD_15_R = new("OFFLOAD_CMD_15", 'h2fc);
      this.OFFLOAD_SDO_0_R = new("OFFLOAD_SDO_0", 'h300);
      this.OFFLOAD_SDO_1_R = new("OFFLOAD_SDO_1", 'h304);
      this.OFFLOAD_SDO_2_R = new("OFFLOAD_SDO_2", 'h308);
      this.OFFLOAD_SDO_3_R = new("OFFLOAD_SDO_3", 'h30c);
      this.OFFLOAD_SDO_4_R = new("OFFLOAD_SDO_4", 'h310);
      this.OFFLOAD_SDO_5_R = new("OFFLOAD_SDO_5", 'h314);
      this.OFFLOAD_SDO_6_R = new("OFFLOAD_SDO_6", 'h318);
      this.OFFLOAD_SDO_7_R = new("OFFLOAD_SDO_7", 'h31c);
      this.OFFLOAD_SDO_8_R = new("OFFLOAD_SDO_8", 'h320);
      this.OFFLOAD_SDO_9_R = new("OFFLOAD_SDO_9", 'h324);
      this.OFFLOAD_SDO_10_R = new("OFFLOAD_SDO_10", 'h328);
      this.OFFLOAD_SDO_11_R = new("OFFLOAD_SDO_11", 'h32c);
      this.OFFLOAD_SDO_12_R = new("OFFLOAD_SDO_12", 'h330);
      this.OFFLOAD_SDO_13_R = new("OFFLOAD_SDO_13", 'h334);
      this.OFFLOAD_SDO_14_R = new("OFFLOAD_SDO_14", 'h338);
      this.OFFLOAD_SDO_15_R = new("OFFLOAD_SDO_15", 'h33c);
    endfunction: new;
