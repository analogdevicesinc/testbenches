...
package custom_test_harness_env_pkg;
  ...
  class custom_test_harness_env extends adi_environment;

    // Agents
    adi_axi_agent_base mng;
    adi_axi_agent_base ddr;
    adi_axi_agent_base ext_ddr_0;
    adi_axi_agent_base ext_ddr_1;
    ...
    virtual interface clk_vip_if #(.C_CLK_CLOCK_PERIOD(3)) ext_ddr_clk_vip_if;
    ...
    function new(
      ...
      input virtual interface clk_vip_if #(.C_CLK_CLOCK_PERIOD(3)) ext_ddr_clk_vip_if,
      ...
      this.ext_ddr_clk_vip_if = ext_ddr_clk_vip_if;
      ...
      this.ext_ddr_0 = new("AXI EXT DDR 0 stub agent", SLAVE, this);
      this.ext_ddr_1 = new("AXI EXT DDR 1 stub agent", SLAVE, this);
    endfunction
    ...
    task start();
      ...
      this.ext_ddr_clk_vip_if.start_clock();

      this.mng.start_master();
      this.ddr.start_slave();
      this.ext_ddr_0.start_slave();
      this.ext_ddr_1.start_slave();
    endtask
