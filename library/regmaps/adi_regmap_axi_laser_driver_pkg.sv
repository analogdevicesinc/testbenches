...
package adi_regmap_axi_laser_driver_pkg;
  ...
  class adi_regmap_axi_laser_driver #(int ID, int PULSE_PERIOD, int PULSE_WIDTH) extends adi_component;
    ...
    class ID_CLASS #(int ID) extends register_base;
      field_base ID_F;
    ...
    class CONFIG_PERIOD_CLASS #(int PULSE_PERIOD) extends register_base;
    ...
    class CONFIG_WIDTH_CLASS #(int PULSE_WIDTH) extends register_base;
    ...
    CONFIG_PERIOD_CLASS #(PULSE_PERIOD) CONFIG_PERIOD_R;
    CONFIG_WIDTH_CLASS #(PULSE_WIDTH) CONFIG_WIDTH_R;
