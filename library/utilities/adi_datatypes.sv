...
package adi_datatypes_pkg;
  ...
  class adi_fifo #(type data_type = int) extends adi_component;
    ...
    function adi_component clone();
      adi_fifo #(data_type) object;
      adi_component parent;

      $cast(parent, this.parent);
    ...
    function void copy(input adi_component object);
    ...
    function int room();
      return this.depth-this.fifo.size();
    endfunction: room
