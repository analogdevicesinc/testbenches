...
package adi_spi_vip_if_base_pkg;
  ...
  virtual class adi_spi_vip_if_base;
    ...
    pure virtual function int get_param_NUM_OF_MISO();

    pure virtual function int get_param_NUM_OF_MOSI();

    pure virtual function int get_param_MISO_LANE_MASK();

    pure virtual function int get_param_MOSI_LANE_MASK();
