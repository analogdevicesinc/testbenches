...
package adi_axis_rand_config_pkg;
  ...
  class adi_axis_rand_config extends adi_object;
    ...
    static logic [7:0] tdata = 8'd0;
    static logic tkeep = 1'b1;
    static logic tstrb = 1'b1;
    static logic [32-1:0] tuser_byte = {32{1'b0}};
    static logic [32-1:0] tid = {32{1'b0}};
    static logic [32-1:0] tdest = {32{1'b0}};
    static logic [32-1:0] tuser_tx = {32{1'b0}};
