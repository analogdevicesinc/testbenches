...
set ad_project_params(ADC_OFFLOAD_MEM_TYPE) 0      ; ## Internal storage
...
set ad_project_params(DAC_OFFLOAD_MEM_TYPE) 0      ; ## Internal storage
set ad_project_params(DAC_OFFLOAD_SIZE) [expr 1024*1024] ; ## Storage size in bytes
