...
# TX sync triggering on the DMA dedicated pin
ad_ip_parameter axi_ad9361_dac_dma CONFIG.SYNC_TRANSFER_START {true}

delete_bd_objs \
  [get_bd_nets logic_or_1_Res] \
  [get_bd_nets axi_tdd_0_tdd_channel_2] \
  [get_bd_cells logic_or_1]
