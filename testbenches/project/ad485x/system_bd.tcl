...
set period [expr {$DEVICE eq {AD4858} ? 200 : \
                  $DEVICE eq {AD4857} ? 200 :
                  $DEVICE eq {AD4856} ? 800 :
                  $DEVICE eq {AD4855} ? 800 :
                  $DEVICE eq {AD4854} ? 200 :
                  $DEVICE eq {AD4853} ? 200 :
                  $DEVICE eq {AD4852} ? 800 :
                  $DEVICE eq {AD4851} ? 800 : 200}]
adi_sim_add_define "PERIOD_T=[format "%d" ${period}]"
