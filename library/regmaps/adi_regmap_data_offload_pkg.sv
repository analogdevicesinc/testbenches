...
package adi_regmap_data_offload_pkg;
  ...
  class adi_regmap_data_offload #(int AUTO_BRINGUP, int HAS_BYPASS, int ID, int MEM_SIZE_LOG2, int MEM_TYPE, int TX_OR_RXN_PATH);
    ...
    function new();
      ...
      this.SYNTHESIS_CONFIG_1_R = new("SYNTHESIS_CONFIG_1", 'h10);
      this.SYNTHESIS_CONFIG_2_R = new("SYNTHESIS_CONFIG_2", 'h14);
      this.SYNTHESIS_CONFIG_3_R = new("SYNTHESIS_CONFIG_3", 'h18);
      this.TRANSFER_LENGTH_R = new("TRANSFER_LENGTH", 'h1c);
      this.MEM_PHY_STATE_R = new("MEM_PHY_STATE", 'h80);
      this.RESET_OFFLOAD_R = new("RESET_OFFLOAD", 'h84);
      this.CONTROL_R = new("CONTROL", 'h88);
      this.SYNC_TRIGGER_R = new("SYNC_TRIGGER", 'h100);
      this.SYNC_CONFIG_R = new("SYNC_CONFIG", 'h104);
      this.FSM_BDG_R = new("FSM_BDG", 'h200);
    endfunction: new;
