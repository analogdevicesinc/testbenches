...
/* Base (common to all cores) */
  ...
  `define SET_COMMON_REG_CONFIG_SELECTABLE_CLOCK(x) SetField(COMMON_REG_CONFIG,"SELECTABLE_CLOCK",x)
  `define GET_COMMON_REG_CONFIG_SELECTABLE_CLOCK(x) GetField(COMMON_REG_CONFIG,"SELECTABLE_CLOCK",x)
  `define DEFAULT_COMMON_REG_CONFIG_SELECTABLE_CLOCK GetResetValue(COMMON_REG_CONFIG,"SELECTABLE_CLOCK")
  `define UPDATE_COMMON_REG_CONFIG_SELECTABLE_CLOCK(x,y) UpdateField(COMMON_REG_CONFIG,"SELECTABLE_CLOCK",x,y)
