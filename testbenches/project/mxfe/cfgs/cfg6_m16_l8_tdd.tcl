...
set ad_project_params(TDD_SUPPORT) 1
set ad_project_params(SHARED_DEVCLK) 1

set ad_project_params(TDD_CHANNEL_CNT) 2
set ad_project_params(TDD_SYNC_WIDTH) 32
