...
#
# Script generated by Vivado on Fri Aug 29 13:28:48 EEST 2025
# SW Build 4029153 on Fri Oct 13 20:13:54 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : system_tb.sh
...
#
# Usage        : system_tb.sh
#                system_tb.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                system_tb.sh [-reset_run]
#                system_tb.sh [-reset_log]
#                system_tb.sh [-help]
#
...
# set xvlog options
xvlog_opts="--incr --relax  -L uvm -L axi_vip_v1_1_15 -L smartconnect_v1_0 -L clk_vip_v1_0_3 -L rst_vip_v1_0_5 -L xilinx_vip"

# set xvhdl options
xvhdl_opts="--incr --relax "

# script info
echo -e "system_tb.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./system_tb.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug all --relax --mt 8 -d "MNG_AXI=mng_axi_vip" -d "DDR_AXI=ddr_axi_vip" -d "SYS_CLK=sys_clk_vip" -d "DMA_CLK=dma_clk_vip" -d "DDR_CLK=ddr_clk_vip" -d "SYS_RST=sys_rst_vip" -d "DDR_BA=2147483648" -d "REF_CLK_RATE=250" -d "RX_NUM_LINKS=1" -d "RX_JESD_S=2" -d "TX_JESD_S=2" -d "TX_NUM_LINKS=1" -d "RX_JESD_F=3" -d "TX_JESD_F=3" -d "TDD_SUPPORT=0" -d "RX_JESD_K=256" -d "JESD_MODE="64B66B"" -d "RX_JESD_L=4" -d "TX_JESD_K=256" -d "RX_JESD_M=4" -d "TX_JESD_L=4" -d "RX_LANE_RATE=16.5" -d "RX_PLL_SEL=2" -d "RX_JESD_NP=12" -d "TX_JESD_M=4" -d "TX_JESD_NP=12" -d "TX_LANE_RATE=16.5" -d "TX_PLL_SEL=2" -d "DRP_CLK=drp_clk_vip" -d "REF_CLK=ref_clk_vip" -d "DEVICE_CLK=device_clk_vip" -d "SYSREF_CLK=sysref_clk_vip" -d "RX_DMA_BA=2084700160" -d "RX_XCVR_BA=1151729664" -d "TX_DMA_BA=2084765696" -d "TX_XCVR_BA=1152778240" -d "AXI_JESD_RX_BA=1151926272" -d "ADC_TPL_BA=1151401984" -d "DAC_TPL_BA=1152450560" -d "AXI_JESD_TX_BA=1152974848" -d "RX_OFFLOAD_BA=2084896768" -d "TX_OFFLOAD_BA=2084831232" -d "TDD_BA=2084962304" -d "TH=test_harness" -d "TB=system_tb" -d "TEST_PROGRAM=test_program"  -d "MNG_AXI=mng_axi_vip" -d "DDR_AXI=ddr_axi_vip" -d "SYS_CLK=sys_clk_vip" -d "DMA_CLK=dma_clk_vip" -d "DDR_CLK=ddr_clk_vip" -d "SYS_RST=sys_rst_vip" -d "DDR_BA=2147483648" -d "REF_CLK_RATE=250" -d "RX_NUM_LINKS=1" -d "RX_JESD_S=2" -d "TX_JESD_S=2" -d "TX_NUM_LINKS=1" -d "RX_JESD_F=3" -d "TX_JESD_F=3" -d "TDD_SUPPORT=0" -d "RX_JESD_K=256" -d "JESD_MODE=\"64B66B\"" -d "RX_JESD_L=4" -d "TX_JESD_K=256" -d "RX_JESD_M=4" -d "TX_JESD_L=4" -d "RX_LANE_RATE=16.5" -d "RX_PLL_SEL=2" -d "RX_JESD_NP=12" -d "TX_JESD_M=4" -d "TX_JESD_NP=12" -d "TX_LANE_RATE=16.5" -d "TX_PLL_SEL=2" -d "DRP_CLK=drp_clk_vip" -d "REF_CLK=ref_clk_vip" -d "DEVICE_CLK=device_clk_vip" -d "SYSREF_CLK=sysref_clk_vip" -d "RX_DMA_BA=2084700160" -d "RX_XCVR_BA=1151729664" -d "TX_DMA_BA=2084765696" -d "TX_XCVR_BA=1152778240" -d "AXI_JESD_RX_BA=1151926272" -d "ADC_TPL_BA=1151401984" -d "DAC_TPL_BA=1152450560" -d "AXI_JESD_TX_BA=1152974848" -d "RX_OFFLOAD_BA=2084896768" -d "TX_OFFLOAD_BA=2084831232" -d "TDD_BA=2084962304" -d "TH=test_harness" -d "TB=system_tb" -d "TEST_PROGRAM=test_program" -L axi_infrastructure_v1_1_0 -L xil_defaultlib -L axi_vip_v1_1_15 -L axi_lite_ipif_v3_0_4 -L axi_intc_v4_1_18 -L xlconcat_v2_1_5 -L clk_vip_v1_0_3 -L rst_vip_v1_0_5 -L lib_cdc_v1_0_2 -L proc_sys_reset_v5_0_14 -L xlconstant_v1_1_8 -L smartconnect_v1_0 -L axi_register_slice_v2_1_29 -L xlslice_v1_0_3 -L util_vector_logic_v2_0_3 -L util_reduced_logic_v2_0_5 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot system_tb xil_defaultlib.system_tb xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim system_tb -key {Behavioral:sim_1:Functional:system_tb} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_0409.protoinst" -protoinst "protoinst_files/bd_c251.protoinst" -protoinst "protoinst_files/test_harness.protoinst" -log simulate.log -sv_seed random
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/emea/mediadata/opt/Xilinx/Vivado/2023.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb system_tb.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./system_tb.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: system_tb.sh [-help]\n\
Usage: system_tb.sh [-step]\n\
Usage: system_tb.sh [-lib_map_path]\n\
Usage: system_tb.sh [-reset_run]\n\
Usage: system_tb.sh [-reset_log]\n\
Usage: system_tb.sh [-keep_index]\n\
Usage: system_tb.sh [-noclean_files]\n\n\
