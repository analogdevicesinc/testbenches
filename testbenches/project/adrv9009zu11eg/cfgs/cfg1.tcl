...
set ad_project_params(DAC_OFFLOAD_TYPE) 1
set ad_project_params(DAC_OFFLOAD_SIZE) [expr 1024*1024*1024]
set ad_project_params(PLDDR_OFFLOAD_DATA_WIDTH) 256

set ad_project_params(TX_JESD_M) 16
set ad_project_params(TX_JESD_L) 16
...
set ad_project_params(RX_OS_JESD_M) 8
set ad_project_params(RX_OS_JESD_L) 8
