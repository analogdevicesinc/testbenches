...
program test_program_lvds (
    ...
    input  adc_0_scki_p_tp,
    input  adc_0_scki_n_tp,
    output adc_0_scko_p_tp,
    output adc_0_scko_n_tp,
    output adc_0_sdo_p_tp,
    output adc_0_sdo_n_tp,
    // ADC 1 ports
    input  adc_1_cnvs_tp,
    output adc_1_busy_tp,
    input  adc_1_scki_p_tp,
    input  adc_1_scki_n_tp,
    output adc_1_scko_p_tp,
    output adc_1_scko_n_tp,
    output adc_1_sdo_p_tp,
    output adc_1_sdo_n_tp
);
  ...
  initial begin
    ...
    `else
      ...
      repeat(num_tests) begin
        ...
        `INFO(("=== AD4858 Dual LVDS Test: case %0d (pf=%0d, crc=%0d, os=%0d) ===", test_idx,
  ...
  task prepare_data(input test_case_t tc);
    ...
    scki_edges_0 = ((NUMB_OF_CH + tc.crc_en) * packet_sz);
    scki_edges_1 = ((NUMB_OF_CH + tc.crc_en) * packet_sz);
    ...
    for (int conv = 0; conv < NO_OF_T; conv = conv + 1) begin
      for (int i = 0; i < NUMB_OF_CH; i = i + 1) begin
        ...
        case ({tc.packet_format, 1'b0, tc.os_en})  // packet_formats=0 (20b)
          4'h0, 4'h1 : begin
  ...
  task capture_data(input test_case_t tc);
    ...
    `INFO(("Verifying ADC 0 LVDS data (%d conversions)", NO_OF_T), ADI_VERBOSITY_LOW);
    for (int conv=0; conv<NO_OF_T; conv=conv+1) begin
      for (int i=0; i<NUMB_OF_CH; i=i+1) begin
    ...
    `INFO(("Verifying ADC 1 LVDS data (%d conversions)", NO_OF_T), ADI_VERBOSITY_LOW);
    for (int conv=0; conv<NO_OF_T; conv=conv+1) begin
      for (int i=0; i<NUMB_OF_CH; i=i+1) begin
  ...
  initial begin
    forever begin
      ...
      if (adc_0_scki_p_tp ^ scki_p_d_0) begin
        ...
        db_i_shift_0 = rx_db_i_0[ch_index_lane_0][db_i_index_0];
      ...
      scki_n_d2_0 = scki_n_d_0;
      scki_p_d2_0 = scki_p_d_0;
      scki_p_d_0  = adc_0_scki_p_tp;
      scki_n_d_0  = adc_0_scki_n_tp;
    end
  end
  ...
  initial begin
    forever begin
      ...
      if (adc_1_scki_p_tp ^ scki_p_d_1) begin
        ...
        db_i_shift_1 = rx_db_i_1[ch_index_lane_1][db_i_index_1];
      ...
      scki_n_d2_1 = scki_n_d_1;
      scki_p_d2_1 = scki_p_d_1;
      scki_p_d_1  = adc_1_scki_p_tp;
      scki_n_d_1  = adc_1_scki_n_tp;
    end
  end

  assign ch_index_lane_0 = (0 + ring_buffer_index_0) == MAXC_INDEX ? 0 :
                           (0 + ring_buffer_index_0) > MAXC_INDEX  ? (0 + ring_buffer_index_0) - 8 :
                            0 + ring_buffer_index_0;

  assign ch_index_lane_1 = (0 + ring_buffer_index_1) == MAXC_INDEX ? 0 :
                           (0 + ring_buffer_index_1) > MAXC_INDEX  ? (0 + ring_buffer_index_1) - 8 :
                            0 + ring_buffer_index_1;

  // ADC 0 outputs
  assign adc_0_busy_tp   = busy_0;
  assign adc_0_sdo_p_tp  = db_i_shift_0;
  assign adc_0_sdo_n_tp  = ~db_i_shift_0;
  assign adc_0_scko_p_tp = scki_p_d2_0;
  assign adc_0_scko_n_tp = scki_n_d2_0;

  // ADC 1 outputs
  assign adc_1_busy_tp   = busy_1;
  assign adc_1_sdo_p_tp  = db_i_shift_1;
  assign adc_1_sdo_n_tp  = ~db_i_shift_1;
  assign adc_1_scko_p_tp = scki_p_d2_1;
  assign adc_1_scko_n_tp = scki_n_d2_1;
